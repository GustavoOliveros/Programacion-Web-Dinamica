...
<div class="contenedor">
    ...
    <form action="TP1_EJ6_Resultado.php" method="get" name="form">
        ...
        <input type="radio" name="sexo" id="sexo-3" value="otro" required>Otro<br>

        Deportes que practica<br>
        <input type="checkbox" name="deportes[]" id="deportes-1" value="Futbol">Futbol<br>
        <input type="checkbox" name="deportes[]" id="deportes-2" value="Basket">Basket<br>
        <input type="checkbox" name="deportes[]" id="deportes-3" value="Voley">Voley<br>
        <input type="checkbox" name="deportes[]" id="deportes-4" value="Hockey">Hockey<br>
        <input type="checkbox" name="deportes[]" id="deportes-5" value="Golf">Golf<br>
        <input type="checkbox" name="deportes[]" id="deportes-6" value="Natación">Natación<br>
        <input type="checkbox" name="deportes[]" id="deportes-7" value="Atletismo">Atletismo
